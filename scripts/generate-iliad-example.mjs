...
const entry = {id:'the-iliad',title:'The Iliad',author:'Homer',blurb:'The wrath of Achilles withdraws the Achaeans’ greatest fighter, destroys Patroclus and Hector, and ends in a meeting between enemies joined by grief.',data:'the-iliad.pwk',dataBytes:Buffer.byteLength(text),counts:{characters:characters.length,chapters:chapters.length,events:events.length,locations:locationMarkers.length},notice:'Unofficial reference for a public-domain ancient epic. This example contains original structural summaries and editorial chronology, not the prose of any translation. Map sourcing and editorial method are recorded in Lore.',worldId:W,cover:commons('Achilles and Priam by Jules Bastien-Lepage.jpg',960)}
