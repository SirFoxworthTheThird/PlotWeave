...
const locRows = [
  ...
  */
  ...
  ['yellow-wind-ridge', 'route', 'Yellow Wind Ridge', 'A ridge whose owner raises a wind out of the earth that blinds anything with eyes, including eyes that have been through a furnace.', null, 470, 296, 'landmark', 'yellow-wind-ridge'],
  ...
  ['pingding-mountain', 'route', 'Pingding Mountain', 'Six hundred li of mountain held by two kings with five treasures between them and a standing order to catch monks.', null, 396, 258, 'landmark', 'pingding-mountain'],
  ...
  ['baolin-monastery', 'route', 'Baolin Monastery', 'A monastery that puts a travelling monk in the corridor to sleep, and is knelt to by five hundred of its own after a stone lion is broken.', null, 380, 300, 'building', 'baolin-monastery'],
  ...
  ['jindou-mountain', 'route', 'Jindou Mountain', 'A mountain with towers in the valley that are not there, and a cave under them whose owner has a bracelet that swallows weapons.', null, 310, 424, 'landmark', 'jindou-mountain'],
  ...
  ['qilin-mountain', 'route', 'Qilin Mountain', 'The mountain the Golden Queen was carried to, and the cave where three bells are kept on a cord at somebody’s belt.', null, 274, 330, 'landmark', 'qilin-mountain'],
  ...
  ['tianzhu-capital', 'route', 'The Capital of India', 'A city with a tower in the crossroads and a princess on top of it choosing a husband by throwing a ball into the crowd.', null, 128, 320, 'city', 'capital-of-india'],
  ...
  /*
    ...
    artwork.
  */
  ['subhuti-cave', 'route', 'The Cave of the Slanting Moon and Three Stars', 'Subhuti’s house on the Mountain of Mind and Heart, somewhere in the Western Continent, where a monkey spends twenty years learning the two things that make the rest of the book possible.', null, 48, 215, 'landmark', 'slanting-moon-cave'],
  ...
  ['changan-daming-palace', 'changan', 'The Daming Palace', 'The Tang court: where the rescript is written, where the emperor comes back from the dead, and where the scriptures are handed over.', null, 736, 122, 'building', 'daming-palace'],
  ...
  ['great-hall', 'vulture-peak', 'The Great Hall', 'Where the Buddha sits on the nine-grade lotus and weighs what the eastern continent can be trusted with.', null, 618, 234, 'building', 'vulture-peak-great-hall'],
  ...
  ['celestial-hall', 'heaven', 'The Hall of Miraculous Mist', 'The throne hall of the Jade Emperor, where petitions are read, titles are invented, and one guest will not be put out of the doorway.', null, 668, 200, 'building', 'hall-of-miraculous-mist'],
...
const charRows = [
  ...
  ['wei-zheng', 'Wei Zheng', [], 'The minister who beheads a dragon in his sleep in the middle of a game of chess with the man who was guarding him.', '#7a6f5a', 'wei-zheng'],
  ['cui-jue', 'Judge Cui', [], 'The underworld clerk who owes his post to a dead minister, and who adds two strokes to a number in the Register of Life and Death.', '#6f6858', 'judge-cui'],
  ['jing-dragon', 'The Dragon King of the Jing River', [], 'A dragon who cheats a rainfall by a few drops to win a bet with a fortune-teller, and loses his head over it.', '#5a7a86', 'jing-river-dragon'],
  ['chen-guangrui', 'Chen Guangrui', [], 'A scholar who takes first place, buys a fish and puts it back, and is murdered at a river crossing on the way to his post.', '#8a7a62', 'chen-guangrui'],
  ['yin-wenjiao', 'Lady Yin', [], 'The chief minister’s daughter who throws the ball, loses her husband at a ford, and keeps a child alive by putting it in the river.', '#a8808a', 'lady-yin'],
  ...
  ['black-bear', 'The Black Bear Spirit', [], 'A bear who reads scripture, keeps a garden, holds literary parties, and steals a cassock out of a fire that is not his.', '#4f4a44', 'black-bear-spirit'],
  ...
  ['qingfeng', 'Clear Wind and Bright Moon', [], 'The two boys left in charge of the orchard, who count the fruit, hand out two, and are still counting when the tree comes down.', '#8f9a7a', 'clear-wind-bright-moon'],
  ...
  ['wuji-king', 'The King of Wuji', [], 'A king pushed down his own well by a guest he had entertained for two years, and left there for three more.', '#8a7a6a', 'wuji-king'],
  ...
  ['blue-lion-impostor', 'The Full-Truth Daoist', [], 'The rainmaker who took a king’s face and his throne, and who turns out to have been sent, and to have been gelded first.', '#6f7a8f', 'blue-lion-impostor'],
  ...
  ['golden-queen', 'The Golden Queen', [], 'The senior consort of Purple Cinnabar, carried off at the Double Fifth and kept three years inside a coat of needles.', '#b58a9a', 'golden-queen'],
  ['zhuzi-king', 'The King of Purple Cinnabar', [], 'A king who swallowed a rice dumpling in terror three years ago and has not been well since, and who kept the reason to himself.', '#9a7a5a', 'zhuzi-king'],
  ...
  ['three-rhinoceros-demons', 'The Three Rhinoceros Kings', ['Cold-Avoiding, Heat-Avoiding and Dust-Avoiding'], 'Three rhinoceroses a thousand years old who have loved scented oil since they were young, and who take it dressed as Buddhas.', '#6f7a72', 'three-rhinoceros-kings'],
  ...
  ['kou-hong', 'Squire Kou', [], 'A man of sixty-four who vowed at forty to feed ten thousand monks, reached the number, and was killed the same night for the send-off he threw.', '#9a8a6a', 'squire-kou'],
  ['kou-wife', 'Mistress Kou', [], 'The only one in the house who looked out from under the bed, and who named the four men she had fed for a fortnight.', '#a89098', 'mistress-kou'],
...
const itemRows = [
  ...
  ['heart-sutra', 'The Heart Sutra', 'Fifty-four lines given away in a nest in a juniper, recited the whole way, and quoted back at the man who learned it whenever he is afraid of a noise.', 'document', 'heart-sutra'],
  ...
  ['gourd-and-vase', 'The Gourd and the Jade Vase', 'Two of Laozi’s five: they take anyone who answers to their own name, and turn them to liquid in an hour and three quarters.', 'artifact', 'gourd-and-jade-vase'],
  ['yin-yang-vase', 'The Yin-Yang Vase', 'Two feet four inches high and thirty-six bearers to carry it, with fire, snakes and three fire-dragons inside — and, after one visit, a hole in the bottom.', 'artifact', 'yin-yang-vase'],
  ...
  ['wind-pill', 'The Wind-Securing Pill', 'The Buddha left it with Lingji and Lingji sewed it into a collar, and it is why the second fanning does not move him.', 'consumable', 'wind-securing-pill'],
  ['sleep-insects', 'The Sleep-Insects', 'Won off a heavenly king at a guessing game five hundred years ago and kept in a belt since, spent one nostril at a time.', 'consumable', 'sleep-insects'],
  ['gold-bracelets', 'The Golden Queen’s Bracelets', 'A pair taken off at the Double Fifth to tie the five-coloured threads, left in a dressing case, and worn up a monkey’s arm as proof.', 'clothing', 'golden-queen-bracelets'],
  ...
  ['register', 'The Register of Life and Death', 'The book with everything alive written in it, from which one entry — stone monkey, three hundred and forty-two years — is struck out with a borrowed brush.', 'document', 'register-of-life-and-death'],
]
