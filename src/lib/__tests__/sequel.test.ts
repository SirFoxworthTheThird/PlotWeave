...
describe('planSequel', () => {
  ...
  it('carries a map: layer + markers, remapping ids and clearing links to dropped layers', () => {
    const layer: MapLayer = { id: 'l1', worldId: 'w1', parentMapId: null, name: 'World', description: '', imageId: 'blob-img', imageWidth: 100, imageHeight: 100, scalePixelsPerUnit: null, scaleUnit: null, createdAt: 0, updatedAt: 0 }
  ...
  it('seeds an opening chapter with each carried character at their ending state', () => {
    const layer: MapLayer = { id: 'l1', worldId: 'w1', parentMapId: null, name: 'World', description: '', imageId: 'img', imageWidth: 1, imageHeight: 1, scalePixelsPerUnit: null, scaleUnit: null, createdAt: 0, updatedAt: 0 }
